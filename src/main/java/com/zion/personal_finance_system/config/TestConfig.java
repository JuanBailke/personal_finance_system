...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Salary s1 = new Salary(null, "Trabalho", Instant.parse("2024-07-31T07:00:00Z"), 5000.00, u1);
		Salary s2 = new Salary(null, "Trabalho", Instant.parse("2024-07-30T07:00:00Z"), 2500.00, u2);
		Salary s3 = new Salary(null, "Serviço", Instant.parse("2024-08-14T07:00:00Z"), 5000.00, u1);
